...
public class OdachiItems implements ILoadableClass {
    ...
    public static final DeferredHolder<Item, Item> ODACHI = ItemsRegistry.newItem("odachi", OdachiItem::new, ITEMS, properties -> properties.rarity(Rarity.RARE).durability(1980).attributes(OdachiItem.createOdachiAttributes()));
    @Override
